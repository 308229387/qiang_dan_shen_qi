...
public class SwitchButton extends CompoundButton {
    ...
    public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        mThumbDrawable = a.getDrawable(R.styleable.SwitchButton_sb_thumb);//获取配置的轨迹资源
        mTrackDrawable = a.getDrawable(R.styleable.SwitchButton_sb_track);//获取配置的开关资源
        mTextOn = a.getText(R.styleable.SwitchButton_sb_textOn);//获取配置中 选中情况下的显示文字  on
        mTextOff = a.getText(R.styleable.SwitchButton_sb_textOff);//获取配置的 为选中情况下的显示文字 off
        mThumbTextPadding = a.getDimensionPixelSize( R.styleable.SwitchButton_sb_thumbTextPadding, 0);//获取配置的按钮字体大小
        mSwitchMinWidth = a.getDimensionPixelSize(R.styleable.SwitchButton_sb_switchMinWidth, 0);//获取配置的最小宽度
        mSwitchPadding = a.getDimensionPixelSize(R.styleable.SwitchButton_sb_switchPadding, 0);//获取配置的padding属性
