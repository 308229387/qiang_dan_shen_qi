...
public class SystemNotiListModel extends ListNetWorkModel{
    ...
    public void loadMore() {
        ...
        String url = URLConstans.URL_SYS_LIST + UrlSuffix.getSysListSuffix(context, "" + current_load_page);
        setRequestURL(url);
    ...
    public void refresh() {
        ...
        String url = URLConstans.URL_SYS_LIST + UrlSuffix.getSysListSuffix(context, "1");
