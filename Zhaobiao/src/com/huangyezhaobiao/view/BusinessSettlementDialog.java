...
public class BusinessSettlementDialog extends Dialog implements View.OnClickListener{
...
//	private String title;
	...
	private CheckBox settlementCheckbox;
	...
	public BusinessSettlementDialog(Context context, String content) {
...
//		 this.title = title;
	...
	private void initView() {
		view = mInflater.inflate(R.layout.settlement_dialog_zhaobiao, null);
		setContentView(view);
...
//		dialog_tv_title   = (TextView) view.findViewById(R.id.dialog_tv_title);
		...
		settlementCheckbox = (CheckBox)view.findViewById(R.id.settlement_checkbox);
...
//	}
	...
	public boolean getCheckBoxState(){
		return settlementCheckbox.isChecked();
	}
